this.perk_barrage <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "perk.barrage";
		this.m.Name = this.Const.Strings.PerkName.Barrage;
		this.m.Description = this.Const.Strings.PerkDescription.Barrage;
